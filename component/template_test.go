...
func TestBasicTemplateToObject(T *testing.T) {
	assert.Test(T, func(T *assert.T) {
		...
		template := c.ObjectTemplate{
			Components: []c.ComponentTemplate{{Type: "*go-component/component_test.FakeComponent"}},
...
! *go-component/component_test.FakeComponent
...
func TestComponentDeserialization(T *testing.T) {
	assert.Test(T, func(T *assert.T) {
		...
		template := c.ObjectTemplate{
			...
			Objects: []c.ObjectTemplate{
				{Name: "First Child"},
				{Name: "D", Components: []c.ComponentTemplate{{Type: "*go-component/component_test.FakeComponent", Data: "Value2,5"}},
					Objects: []c.ObjectTemplate{
						{Name: "C", Components: []c.ComponentTemplate{{Type: "*go-component/component_test.FakeComponent", Data: "Value1,1"}}},
						{Name: "Last Child"}}}}}
